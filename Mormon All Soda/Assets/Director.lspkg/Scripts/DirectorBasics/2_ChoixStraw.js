...
function NextFlavoor()
{
    ...
    StrawInLeftRigthEvent.event.reset(0)
...
const ScaleStrawAnim = new Animation(script.getSceneObject(), 0.15, ScaleStraw,RepeatMode.PingPong);
ScaleStrawAnim.Easing=QuadraticInOut;
function ScaleStraw(ratio)
{    
    script.Straw[idToGoTo].getComponent("Component.Image").getTransform().setLocalScale(
